...
<div class="container">
    <?php 
        if($g_nums > 0){
            $i=1;
            foreach($g_thumbnail as $thumbnail) : ?>
                <div class="mySlides">
                    <div class="numbertext"><?=$i?> / <?=$g_nums;?></div>
                    <img src="<?=base_url('assets/images/gallery/'.$thumbnail['gallery_id'].'/'.$thumbnail['img_name']);?>" style="width:100%" alt="<?=$thumbnail['img_name'];?>">
                </div>
           <?php 
            $i++;
            endforeach;
            ...
            <div class="mySlides">
                ...
                <img src="<?=base_url('assets/images/gallery/cover/'.$g_desc[0]['id'].'/'.$g_desc[0]['img_cover']);?>" style="width:100%" alt="<?=$g_desc[0]['name'];?>">
            </div>
    <?php }
    ?>
    <!-- <div class="mySlides">
    ...
    <div class="row ml-2 mr-2">
        <?php
            if($g_nums > 0){ 
                $j=1;
                foreach($g_thumbnail as $item_thumbnail) : ?>
                    <div class="column">
                        <img class="demo cursor" src="<?=base_url('assets/images/gallery/'.$item_thumbnail['gallery_id'].'/'.$item_thumbnail['img_name']);?>" style="width:80%" onclick="currentSlide(<?=$j;?>)">
                    </div>
                <?php 
                $j++;
                endforeach; ?>
