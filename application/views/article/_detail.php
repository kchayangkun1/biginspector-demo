...
<section style="background-color: #eee4d9;">
    <div class="container">
        <div class="row ml-2 mr-2">
            <div data-aos="fade-up"data-aos-duration="1000">
                <div class="card" style="width: 100%;border-radius: 15px;">
                    <h3 id="detailarticle-heading" class="mt-3 ml-3 mr-3">สไตล์การแต่งบ้านยอดนิยม อยู่อย่างไรก็ไม่เบื่อ</h3>
                        <h4 id="detailarticle-h4" class="mt-2 mb-3 ml-3 mr-3">หากคุณกำลังตัดสินใจตกแต่งหรือรีโนเวทบ้านสักหลัง แต่กลัวว่านานไปแล้วจะเบื่อ วันนี้ 32 Interior Design มีสไตล์การออกแบบที่อยู่อย่างไรก็ไม่เบื่อ นานแค่ไหนก็ดูไม่เก่ามาให้ชมกัน</h4>
                </div>
        ...
        <div class="row ml-2 mr-2">
            <div data-aos="fade-up"data-aos-duration="1000">
                <div class="card" style="width: 100%;border-radius: 15px;">
                    <!-- <h3 class="mt-3 ml-3 mr-3">เน้นพื้นที่ใช้สอยให้ได้ประโยชน์สูงสุด</h3> -->
