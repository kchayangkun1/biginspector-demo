			                  		...
			                  		<div class="fixed-table-toolbar">
			                  			<div class="bs-bars pull-left">
			                  				<!-- <div class="btn-group hidden-sm-down" id="exampleToolbar" role="group">
							                    <button type="button" class="btn btn-success btn-outline btn-sm" onclick="window.location.href = '<?=base_url('Admin/form_homebanner');?>';">
			                  					...
			                  					<tbody>
													...
													?>
			                  						<tr> 
			                  							...
			                  							<td>
			                  								<button type="button" class="btn btn-round btn-warning btn-sm" onclick="window.location.href = '<?=base_url('Admin/edit_homebanner/'.$val_item['id']);?>';"><i class="icon wb-pencil" aria-hidden="true"></i></button>
			                  								<!-- <button type="button" class="btn btn-round btn-danger btn-sm" onclick="delRw(<?=$val_item['id']; ?>)"><i class="icon wb-close" aria-hidden="true"></i></button> -->
			                  							</td> 
			                  						</tr>
			                  						<?php
			                  							$i++;
