...
<head>
	...
	<meta name="description" content="SJT GROUP">
	<meta name="author" content="SJT GROUP">

	<title>Home Banner | SJT GROUP </title>
					...
					<!-- Panel Static Labels -->
		          	<div class="panel">
			            <div class="panel-heading">
			              <h3 class="panel-title">เพิ่มแบนเนอร์</h3>
			            </div>
			            <div class="panel-body container-fluid">
			              	<form action="<?=base_url('Admin/create_bannerhome');?>" id="productAdd" name="productAdd" class="form-horizontal" method="post" enctype="multipart/form-data">
							  <input type="hidden" name="<?=$this->security->get_csrf_token_name();?>" value="<?=$this->security->get_csrf_hash();?>" >
								...
								<div class="form-group form-material form-material-file" data-plugin="formMaterial">
				                  	<label class="form-control-label" for="image">ภาพแบนเนอร์</label>
									<div id="width"></div>
