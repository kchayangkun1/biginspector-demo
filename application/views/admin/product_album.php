...
<head>
	...
	<meta name="description" content="Mookrolex">
	<meta name="author" content="Mookrolex">

	<title>Servies | Mookrolex </title>
			                  						...
			                  						<tr> 
														...
														<td style="">
															<?php if ($val_item['is_active'] == '1') : ?>
			                  									<button class="btn btn-sm btn-success btn-icon btn-floating" type="button" onclick="sChange(<?=$val_item['simg_id']; ?>, 0)"><i class="icon wb-check" aria-hidden="true"></i></button>
			                  								<?php else : ?>
			                  									<button class="btn btn-sm btn-danger btn-icon btn-floating" type="button" onclick="sChange(<?=$val_item['simg_id']; ?>, 1)"><i class="icon wb-close" aria-hidden="true"></i></button>
			                  								<?php endif; ?>
			                  							</td>
														<td>
		...
		<div class="modal-dialog modal-md">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<h6>รายการที่เลือกจะไม่แสดงผลในหน้าเว็บ</h6>
				</div>
				<div class="modal-footer">
