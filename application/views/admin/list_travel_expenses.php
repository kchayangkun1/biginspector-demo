...
<body class="">
		...
		<div class="page-content container-fluid">
	      	...
	      	<div class="panel">
		        <div class="panel-heading">
		          	<h3 class="panel-title">ค่าเดินทาง</h3>
		        </div>
			                  		...
			                  		<div class="fixed-table-toolbar">
			                  			<div class="bs-bars pull-left">
			                  				<div class="btn-group hidden-sm-down" id="exampleToolbar" role="group">
							                    <button type="button" class="btn btn-success btn-outline btn-sm" onclick="window.location.href = '<?=base_url('Admin/form_expenses');?>';">
			                  				...
			                  				<table id="exampleTableToolbar" data-mobile-responsive="true" class="table table-hover" data-pagination="true" data-search="true" style="margin-top: 0px;">
			                    				<thead style="">
			                    					<tr>
			                    						...
			                    						<th style="" data-field="พื้นที่" data-align="center">
			                    							<div class="th-inner ">พื้นที่</div>
			                    							<div class="fht-cell"></div>
			                    						</th>
                                                        <th style="" data-field="ระยะทาง(รัศมี) กม." data-align="center">
			                    							<div class="th-inner ">ระยะทางไม่เกิน(รัศมี) กม.</div>
			                    							<div class="fht-cell"></div>
			                    						</th>
                                                        <th style="" data-field="ราคา/กม." data-align="center">
			                    							<div class="th-inner ">ราคา/กม.</div>
			                    							<div class="fht-cell"></div>
			                    						</th>
			                    				...
			                    				<?php if(!empty($expenses)) : ?>
			                  					<tbody>
			                  						<?php 
													$i = 0;
													foreach($expenses as $val_item) : ?>
			                  						<tr> 
			                  							<td class=""><?=$i+1; ?></td> 
			                  							<td style=""><?=$val_item['name']; ?></td>
                                                        <td style=""><?=$val_item['tr_distance']; ?></td>
                                                        <td style=""><?=$val_item['price']; ?></td>
														...
														<td style="">
			                  							...
			                  							<td>
			                  								<button type="button" class="btn btn-round btn-warning btn-sm" onclick="window.location.href = '<?=base_url('Admin/edit_expenses/'.$val_item['id']);?>';" data-toggle="tooltip" data-placement="top" title="Edit"><i class="icon wb-pencil" aria-hidden="true"></i></button>
	...
	<script type="text/javascript">
		...
		function changeStatus()
		{
			$.ajax({
				type 	: 'POST',
				url 	: '<?=base_url("Admin/distroy_expenses"); ?>',
