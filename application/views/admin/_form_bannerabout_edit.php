...
<head>
	...
	<title>Edit Banner About  | SJT PICO </title>
					...
					<!-- Panel Static Labels -->
		          	<div class="panel">
			            <div class="panel-heading">
			              <h3 class="panel-title">เกี่ยวกับ > แก้ไขแบนเนอร์</h3>
			            </div>
			            <div class="panel-body container-fluid">
			              	<form action="<?=base_url('Admin/update_bannerabout');?>" id="aboutusAdd" name="aboutusAdd" class="form-horizontal" method="post" enctype="multipart/form-data">
							  ...
							  <div class="form-group form-material" data-plugin="formMaterial">
								...
								<div class="form-group form-material form-material-file" data-plugin="formMaterial">
									...
									<div id="width"></div>
									  ...
									  data-default-file="<?=base_url('./assets/images/banner/about/'. $banner_descs[0]['img_cover']);?>" data-allowed-file-extensions="png jpg jpeg PNG JPG JPEG"/>
				                ...
				                <div class="text-right">
				                	<input type="hidden" name="bannerabout_id" value="<?=$banner_descs[0]['id']; ?>">
