					...
					<!-- Panel Static Labels -->
		          	<div class="panel">
			            <div class="panel-heading">
			              <h3 class="panel-title">แก้ไข เกี่ยวกับเรา</h3>
			            </div>
			            <div class="panel-body container-fluid">
			              	<form action="<?=base_url('Admin/update_about');?>" id="aboutusAdd" name="aboutusAdd" class="form-horizontal" method="post" enctype="multipart/form-data">
							  <input type="text" class="form-control" id="name" name="name" value="<?=$about_dscs[0]['name']; ?>" required>
							  ...
							  <div class="form-group form-material" data-plugin="formMaterial">
								...
								<div class="form-group form-material form-material-file" data-plugin="formMaterial">
									...
									<div id="width"></div>
									  ...
									  data-default-file="<?=base_url('./assets/images/about/cover/'.$about_dscs[0]['id'].'/'. $about_dscs[0]['img_cover']);?>" data-allowed-file-extensions="png jpg jpeg PNG JPG JPEG"/>
									  <p class="help-block"><i>
									รองรับไฟล์ภาพ <br>
									ขนาดภาพแนะนำ 773X621px <br> 
				                ...
				                <div class="text-right">
				                	<input type="hidden" name="about_id" value="<?=$about_dscs[0]['id']; ?>">
