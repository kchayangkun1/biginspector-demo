...
<meta http-equiv="X-UA-Compatible" content="IE=edge">
	...
	<title>Article | Big Inspector</title>
			            ...
			            <div class="panel-body container-fluid">
                              ...
                              <input type="hidden" name="<?=$this->security->get_csrf_token_name();?>" 
				                ...
				                <div class="text-right">
						            ...
						            <button type="button" class="btn btn-animate btn-animate-side btn-default btn-outline" onclick="window.location.href = '<?=base_url('Admin/categories');?>';">
