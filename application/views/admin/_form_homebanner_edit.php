...
<head>
	...
	<title>Edit Banner Home  | SJT Group </title>
					...
					<!-- Panel Static Labels -->
		          	<div class="panel">
			            ...
			            <div class="panel-body container-fluid">
			              	<form action="<?=base_url('Admin/update_bannerhome');?>" id="aboutusAdd" name="aboutusAdd" class="form-horizontal" method="post" enctype="multipart/form-data">
							  ...
							  <div class="form-group form-material" data-plugin="formMaterial">
								...
								<div class="form-group form-material form-material-file" data-plugin="formMaterial">
									...
									<div id="width"></div>
									  ...
									  data-default-file="<?=base_url('./assets/images/banner/'.$banner_descs[0]['id'].'/'. $banner_descs[0]['img_cover']);?>" data-allowed-file-extensions="png jpg jpeg PNG JPG JPEG"/>
									  <p class="help-block"><i>
									รองรับไฟล์ภาพ <br>
									ขนาดภาพ 1939X730px <br> 
				                ...
				                <div class="text-right">
				                	<input type="hidden" name="bannerhome_id" value="<?=$banner_descs[0]['id']; ?>">
						            ...
						            <button type="button" class="btn btn-animate btn-animate-side btn-default btn-outline" onclick="window.location.href = '<?=base_url('Admin/banner_home');?>';">
