...
<head>
	...
	<title>Services | Big Inspector </title>
		...
		<div class="page-content container-fluid">
	      	...
	      	<div class="panel">
		        <div class="panel-heading">
		          	<h3 class="panel-title">อัตราค่าบริการ</h3>
		        </div>
			                  			...
			                  			<div class="bs-bars pull-left">
			                  				<div class="btn-group hidden-sm-down" id="exampleToolbar" role="group">
							                    <button type="button" class="btn btn-success btn-outline btn-sm" onclick="window.location.href = '<?=base_url('Admin/form_service');?>';">
							                      	<i class="icon wb-plus" aria-hidden="true"></i> เพิ้ม 
							                    </button>
			                  				</div>
			                  			</div>
			                  		</div>
			                  				...
			                  				<table id="exampleTableToolbar" data-mobile-responsive="true" class="table table-hover" data-pagination="true" data-search="true" style="margin-top: 0px;">
			                    				<thead style="">
			                    					<tr>
			                    						...
			                    						<th style="" data-field="ประเภทที่อยู่อาศัย" data-align="center">
			                    							<div class="th-inner ">ประเภทที่อยู่อาศัย</div>
			                    							<div class="fht-cell"></div>
			                    						</th>
                                                        <th style="" data-field="จำนวนชั้น" data-align="center">
			                    							<div class="th-inner ">จำนวนชั้น</div>
			                    							<div class="fht-cell"></div>
			                    						</th>
                                                        <th style="" data-field="ขนาดพื้นที่ใช้สอย" data-align="left">
			                    							<div class="th-inner ">ขนาดพื้นที่ใช้สอย(ตรม.)</div>
			                    							<div class="fht-cell"></div>
			                    						</th>
                                                        <th style="" data-field="ค่าเดินทาง(บ.)/กม." data-align="left">
			                    							<div class="th-inner ">ค่าเดินทาง(บ.)/กม.</div>
			                    							<div class="fht-cell"></div>
			                    						</th>
                                                        <th style="" data-field="ส่วนลด/โปรโมชั่น" data-align="center">
			                    							<div class="th-inner ">ส่วนลด/โปรโมชั่น</div>
			                    							<div class="fht-cell"></div>
			                    						</th>
                                                        <th style="" data-field="ราคา" data-align="center">
			                    							<div class="th-inner ">ราคา</div>
			                    							<div class="fht-cell"></div>
			                    						</th>
                                                        <th style="" data-field="ราคา(เพิ่ม)/ตรม." data-align="center">
			                    							<div class="th-inner ">ราคา(เพิ่ม)/ตรม.</div>
			                    							<div class="fht-cell"></div>
			                    						</th>

														</th>
			                    						<th style="" data-field="วันที่สร้าง" data-align="center">
			                    							<div class="th-inner ">วันที่สร้าง</div>
			                    							<div class="fht-cell"></div>
			                    						</th>
														<th style="" data-field="สถานะ" data-align="center">
			                    				...
			                    				<?php if(!empty($services)) : ?>
			                  					<tbody>
			                  						<?php 
													$i = 0;
													foreach($services as $val_item) : ?>
			                  						<tr> 
			                  							<td class=""><?=$i+1; ?></td> 
			                  							<td style=""><?=$val_item['t_name']; ?></td>
                                                        <td style=""><?=$val_item['floor']; ?></td>
                                                        <td style=""><?=$val_item['usable_area'];?> | <?=$val_item['remark'];?></td>
                                                        <td style=""><?=$val_item['travel_price'];?> บ. | <?=$val_item['travel_name']; ?></td>
                                                        <td style=""><?=number_format($val_item['discount'],2);?> | <?=$val_item['discount_type']; ?></td>
                                                        <td style=""><?=number_format($val_item['price'],2); ?></td>
                                                        <td style=""><?=$val_item['add_charge']; ?></td>
