...
<head>
	...
	<title>Home Banner  | 32Decor </title>
					...
					<!-- Panel Static Labels -->
		          	<div class="panel">
			            <div class="panel-heading">
			              <h3 class="panel-title">Home Banner</h3>
			            </div>
			            <div class="panel-body container-fluid">
							  ...
							  <div class="form-group form-material" data-plugin="formMaterial">
								...
								<input type="text" class="form-control" id="name" name="name" value="<?=$banner[0]['name']; ?>" required>
				                </div>
								...
								<div class="form-group form-material form-material-file" data-plugin="formMaterial">
									...
									<div id="width"></div>
									  ...
									  data-default-file="<?=base_url('./assets/images/banner/'. $banner[0]['img_cover']);?>" data-allowed-file-extensions="png jpg jpeg PNG JPG JPEG"/>
									  <p class="help-block"><i>
									รองรับไฟล์ภาพ <br>
									ขนาดภาพแนะนำ 1920X890px <br> 
				                ...
				                <div class="text-right">
				                	<input type="hidden" name="banner_id" value="<?=$banner[0]['id']; ?>">
