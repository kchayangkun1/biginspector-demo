...
<body class="">
			                  		...
			                  		<div class="fixed-table-toolbar">
			                  			<div class="bs-bars pull-left">
			                  				<div class="btn-group hidden-sm-down" id="exampleToolbar" role="group">
							                    <button type="button" class="btn btn-success btn-outline btn-sm" onclick="window.location.href = '<?=base_url('Admin/form_portfolio');?>';">
			                  				...
			                  				<table id="exampleTableToolbar" data-mobile-responsive="true" class="table table-hover" data-pagination="true" data-search="true" style="margin-top: 0px;">
			                    				...
			                    				<?php if(!empty($portfolios)) : ?>
			                  					<tbody>
			                  						<?php 
													$i = 0;
													foreach($portfolios as $val_item) : 
													?>
			                  						<tr> 
			                  							<td class=""><?=$i+1; ?></td> 
														...
														<td style="">
															<?php if ($val_item['is_recommend'] == '1') : ?>
			                  									<button class="btn btn-sm btn-success btn-icon btn-floating" type="button" onclick="sChange(<?=$val_item['id']; ?>, <?=$val_item['is_recommend'];?>)"><i class="icon wb-check" aria-hidden="true"></i></button>
			                  								<?php else : ?>
			                  									<button class="btn btn-sm btn-danger btn-icon btn-floating" type="button" onclick="sChange(<?=$val_item['id']; ?>, <?=$val_item['is_recommend'];?>)"><i class="icon wb-close" aria-hidden="true"></i></button>
			                  								<?php endif; ?>
			                  							</td>
														<td style="">
			                  							...
			                  							<td>
			                  								<button type="button" class="btn btn-round btn-warning btn-sm" onclick="window.location.href = '<?=base_url('Admin/edit_portfolio/'.$val_item['id']);?>';" data-toggle="tooltip" data-placement="top" title="Edit"><i class="icon wb-pencil" aria-hidden="true"></i></button>
		...
		<div class="modal-dialog modal-md">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel2">ตั้งค่า</h4>
				</div>
		...
		<div class="modal-dialog modal-md">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<h6>ปรับเปลี่ยนสถานะการแสดงผลรายการแนะนำ</h6>
				</div>
				<div class="modal-footer">
	...
	<script type="text/javascript">
		...
		function changeStatus()
		{
			$.ajax({
				type 	: 'POST',
				url 	: '<?=base_url("Admin/changePortStatus"); ?>',
